...
(function(window, document, exports, global, define, undefined) {
	...
	(function() {
		...
		function L(a, b) {
			1 === b.a ? m(a, b.b) : 2 === a.a ? g(a, b.b) : u(b,
			void 0, function(b) {
				q(a, b)
			}, function(b) {
				g(a, b)
		...
		function q(a, b) {
			if (a === b)
				...
				if (b.constructor === a.constructor)
					...
					c === v ? g(a, v.error) :
					void 0 === c ? m(a, b) : s(c) ? K(a, b, c) : m(a, b)
				}
			else
				m(a, b)
		}
		...
		k.prototype.k = function() {
			for (var a = this.length, b = this.c, c = this.m, d = 0;
			void 0 === b.a && d < a; d++)
				this.j(c[d], d)
		};
		k.prototype.j = function(a, b) {
			...
			void 0 !== a.a ? (a.f = null, this.g(a.a, b, a.b)) : this.q(c.resolve(a), b) : (this.d--, this.b[b] = this.h(a))
		};
	...
	window.html2canvas = function(nodeList, options) {
		...
		options.imageTimeout = typeof (options.imageTimeout) === "undefined" ? 1000 : options.imageTimeout;
	...
	ImageLoader.prototype.fetch = function(nodes) {
		...
		timeoutref = this.getPromise;
		this.ready = Promise.all(this.images.map(timeoutref, this));
	...
	function calculateCurvePoints(bounds, borderRadius, borders) {
		var x = bounds.left, y = bounds.top, width = bounds.width, height = bounds.height, tlh = borderRadius[0][0], tlv = borderRadius[0][1], trh = borderRadius[1][0], trv = borderRadius[1][1], brh = borderRadius[2][0], brv = borderRadius[2][1], blh = borderRadius[3][0], blv = borderRadius[3][1];
